...
run_coupler() {
  ...
  set -x
	jsrun -n 6 -r 6 -a 1 -g 1 -c 1 -b rs -EOMP_NUM_THREADS=1 ${rdmaVars} /gpfs/alpine/scratch/jmerson/fus123/buildWDMApp/test/xgc_n0_server 590kmesh.osh 590kmesh_6.cpn 8 >>${outfile} &
  set +x
  module purge
}
...
run_xgc() {
  ...
  set -x
	jsrun -n 24 -r 6 -a 1 -g 1 -c 7 -b rs -EOMP_NUM_THREADS=14 ${rdmaVars} /gpfs/alpine/scratch/jmerson/fus123/xgc_delta_f/bin/xgc-es-cpp-gpu &>>${outfile} &
  set +x
  module purge
}
