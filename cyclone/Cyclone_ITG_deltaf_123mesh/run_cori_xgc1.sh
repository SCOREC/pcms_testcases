...
#SBATCH --job-name=Cyclone_37k_nphi=8_nnode=1
#SBATCH -o Cyclone_37k.%j.out
#SBATCH -e Cyclone_37k.%j.err
...
srun -n 16 -c 16 --cpu_bind=cores $xgc_bin_path >& Cyclone_37k_${SLURM_JOB_ID}.log
